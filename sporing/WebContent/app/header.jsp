			...
			<div class="start-container">
				...
				<div class="user-info-container">
					...
					<div class="user-info-wrap">
						<a class="join-a-tag text-main" href="join.jsp"> <strong>회원가입</strong>
						</a> <a href="#"></a> <a class="text-main login-a-tag" href="login.jsp"> <strong>로그인</strong>
			...
			<div class="menu-container">
				<div class="navi-content">
					<a id="navi" class="active" style="cursor: pointer;"
						href="m_recruitList.jsp">용병모집</a> <a id="navi"
						style="cursor: pointer;" href="m_replyList.jsp">용병소개</a> <a
						id="navi" style="cursor: pointer;" href="t_matchList.jsp">팀 매치</a>
					<a id="navi" style="cursor: pointer;">커뮤니티</a>
				</div>
			</div>
		</header>
