		...
		<div class="row-no-gutters">
			<div class="col">
				<div class="p-3">
					...
					<div class="d-flex">
						<button class="btn btn-link btn-main py-0" type="button" onclick = "location.href = 'findId.jsp'"> 
							<p style="color:blue;">아이디 찾기</p>
						</button>
						<button class="btn btn-link btn-main py-0" type="button" onclick = "location.href = 'findPw.jsp' "> 
