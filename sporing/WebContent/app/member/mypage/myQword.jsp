	...
	<div class="root-container">
		...
		<ul class="list-group list-group-flush text-center">
			<li class="list-group-items">
				...
				<div class="match-wrap">
					<div class="ground-wrap">
						<a href=""><p><strong>서울특별시 동작구</strong><img src="/images/mypage/document.svg"></p></a>
			...
			<li class="list-group-items">
				...
				<div class="match-wrap">
					<div class="ground-wrap">
						<a href=""><p><strong>서울특별시 서초구</strong><img src="/images/mypage/document.svg"></p></a>
						<p class="parking-wrap">
			...
			<li class="list-group-items">
				...
				<div class="match-wrap">
					<div class="ground-wrap">
						<a href=""><p><strong>부산광역시 해운대구</strong><img src="/images/mypage/document.svg"></p></a>
						<p class="parking-wrap">
