	...
	<div class="root">
		<header class="navi-container">
			<div class="start-container">
				<a href="#" class="logoimg">sporing </a>
				<div class="user-info-container">
					<!-- <input id="isLoggedIn" type="hidden">  -->
					<div class="user-info-wrap">
						<a class="join-a-tag text-main" href="#"> <strong>회원가입</strong>
						</a> <a class="text-main login-a-tag" href="#"> <strong>로그인</strong>
			...
			<div class="menu-container">
				<div class="navi-content">
					<a id="navi" class="active" href="/app/capt/m_recruitList.jsp"style="cursor: pointer;">용병모집</a> 
					<a id="navi" href="/app/capt/m_replyList.jsp" style="cursor: pointer;">용병신청</a> 
					<a id="navi" href="/app/capt/t_matchList.jsp"  style="cursor: pointer;">팀 매치</a> 
					<a id="navi" href="/app/member/mypage.jsp"  style="cursor: pointer;">마이페이지</a> 
