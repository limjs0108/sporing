...
<div class="row">
<div class="col">
<form action="joinDB.jsp" class="page-wrap" onsubmit="return fnJoin()">
...
<label>이메일(아이디)</label>
<input class="form-control mt-1" type="text" name="email" id="emails" placeholder="이메일">
</div>
</div>
<div class="row-wrap mb-3">
<div class="input-wrap">
<label>비밀번호</label>
<input class="form-control mt-1" type="password" name="pw" placeholder="비밀번호">
</div>
</div>
<div class="row-wrap mb-3">
<div class="input-wrap">
<label>비밀번호 확인</label>
<input class="form-control mt-1" type="password" name="pw_chk" placeholder="비밀번호 확인">
</div>
</div>
<div class="row-wrap mb-3">
<div class="input-wrap">
<label>주소</label>
<input class="form-control mt-1" type="text" name="state" placeholder="주소">
</div>
</div>
<div class="row-wrap mb-3">
...
<label>이름</label>
<input class="form-control mt-1" type="text" name="name" placeholder="이름(닉네임)">
</div>
<div class="input-wrap col-6">
<label>성별</label>
<div class="row py-1">
...
<div class="row no-gutters mb-3">
	<div class="form-group flex-grow">
		<div class="input-wrap">
			...
			<div class="d-flex">
				<input class="form-control my-0" type="text"  id="copied" name="certifiedNumber" placeholder="위에서 입력한 이메일이 자동 입력됩나다">
				<button class="btn btn-male text-nowrap m-0" type="button" name="btnCertify" >확인</button>
			</div>
		</div>		
	</div>
			<div class="text-caution"> 
			<img src="/images/img/caution.svg" width="12">
			<small class="ml-2">최초 인증 받은 이메일로 매치 및 이벤트 알림이 발송되오니 바르게 작성해 주세요.</small>
		</div>
</div>
<div class="row no-gutters mb-3">
	<div class="form-group flex-grow">
