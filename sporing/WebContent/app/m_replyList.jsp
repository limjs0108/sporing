...
<body>
	...
	<div class="root">
		...
		<section>
			<div class="filter">
				<div class="s-select">
					<span class="material-symbols-outlined"> sports_soccer </span><a
						href="#">종목 선택</a>
				</div>
				<div class="lo-select">
				...
				<li>
					...
					<div class="able-info">
						...
						<span id="lo">서울</span> <span id="time"> 19:00 - 20:00</span> <span
							id="name"> minmin</span>
					</div > <a href="m_replyDetail.jsp" class="profile"><img
						src="profile1.jpeg" width="100" height="100"> </a>
				</li>
				<li>
					<div class="able-date">
						<p>05월 15일</p>
